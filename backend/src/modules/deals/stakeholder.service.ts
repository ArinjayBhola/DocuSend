...
import { StakeholderInput } from './deals.validation.js';
...
export class StakeholderService {
  ...
  async addStakeholder(dealId: number, userId: number, input: StakeholderInput) {
