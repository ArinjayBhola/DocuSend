      ...
      <div className="w-full max-w-md mx-auto">
        <div className="bg-white p-8 md:p-10 rounded-2xl shadow-xl border border-neutral-100 relative overflow-hidden">
          ...
          <div className="text-center mb-8">
            ...
            <p className="mt-2 text-sm text-neutral-500 font-medium">Please enter your details to sign in.</p>
          </div>
          ...
          <p className="mt-8 text-center text-sm font-medium text-neutral-500">
            ...
            <Link justify-center to="/register" className="text-brand-600 hover:text-brand-700 hover:underline underline-offset-4 transition-all">
              Sign up for free
            </Link>
          </p>
        </div>
